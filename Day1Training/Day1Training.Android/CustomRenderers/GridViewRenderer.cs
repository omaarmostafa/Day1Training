...
using FormsGridView = Day1Training.GridView;
...
namespace Day1Training.Droid
{
    ...
    public class GridViewAdapter : RecyclerView.Adapter
    {
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            Element.ItemTemplate.CreateContent() as Day1Training.FastGridCell :
            Element.GroupHeaderTemplate.CreateContent() as Day1Training.FastGridCell;
    ...
    public class GridViewCellContainer : ViewGroup
    {
        ...
        Day1Training.FastGridCell _viewCell;
        ...
        public GridViewCellContainer(Context context, Day1Training.FastGridCell viewCell, global::Android.Views.View parent, Xamarin.Forms.Size initialCellSize) : base(context)
        {
